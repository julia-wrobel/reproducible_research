...
```{bash, eval = FALSE}
docker run -e PASSWORD="SECRET123" -p 8787:8787 rocker/rstudio:4.4.1
```
...
__Exercise__: Sign in via your browser to the R Studio session that is running. Confirm that you can see project related files. Open the report document and attempt to knit the report. What happens?
